...
public class Client {
    ...
    public static void main(String[] args) throws IOException {
        ...
        StreamObserver<BidirectionalServiceOuterClass.ClientRequest> serverStream =
                stub.bidirectional(new StreamObserver<BidirectionalServiceOuterClass.ServerResponse>() {
        ...
        serverStream.onNext(BidirectionalServiceOuterClass.ClientRequest.newBuilder().setStringRequest(msg).build());
